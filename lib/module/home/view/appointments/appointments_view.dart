...
class _AppointmentsViewState extends State<AppointmentsView> {
  ...
  Column _myAppointments() {
    ...
    return Column(
      children: [
        StreamBuilder(
          stream: homeController.viewAllAppoinment.value
          ...
          builder: (
            ...
            return AnimatedCrossFade(
              ...
              crossFadeState: homeController.viewAllAppoinment.value
        ...
        Obx(
              () => CommonAppButton(
            onTap: () {
              homeController.viewAllAppoinment.value =
              !homeController.viewAllAppoinment.value;
              setState(() {});
            },
            text: homeController.viewAllAppoinment.value
                ? "View Less"
                : "View All",
